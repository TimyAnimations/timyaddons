...
// let test_bool = false;
// let test_bool2 = true;
// let test_bool3 = false;
// let test = new GuiMenu(10, 200, [
//     new Label("Example:\n").alignCenter().setBackgroundColor(Renderer.color(85, 85, 85)).disableBackgroundFill(), 
...
//     new Button("&0BUTTON 6\n", () => { ChatLib.chat("CLICKED 6"); }).setBackgroundColor(Renderer.color(85, 255, 85)),
//     new Checkbox("CHECKBOX 1", () => { test_bool = !test_bool }, () => test_bool ).alignCenter(),
//     new Checkbox("   CHECKBOX 2\n", () => { test_bool2 = !test_bool2 }, () => test_bool2 ).alignCenter(),
//     new Textbox("TEXT BOX 1\n", (string) => {ChatLib.chat(`TEXT BOX 1 "${string}"`);}),
//     new Label("Enter Text: "),
//     new Textbox("TEXT BOX 2\n", (string) => {ChatLib.chat(`TEXT BOX 2 "${string}"`);}),
//     new Row(
//         new Button("&0ROW BUTTON 1", () => { ChatLib.chat("CLICKED ROW 1"); })
//             .setBackgroundColor(Renderer.color(255, 85, 85)).alignCenter(),
//         new Button("&0ROW BUTTON 2", () => { ChatLib.chat("CLICKED ROW 2"); })
//             .setBackgroundColor(Renderer.color(85, 255, 85)).alignCenter(),
//         new Checkbox("&0ROW CHECKBOX", () => { test_bool3 = !test_bool3 }, () => test_bool3)
//             .setBackgroundColor(Renderer.color(85, 85, 255))
//             .setCheckboxColor(Renderer.color(10, 10, 10), Renderer.color(255, 255, 255))
//             .alignCenter(),
//         new Textbox("ROW TEXTBOX").alignCenter()
//     )
// ]);
